...
describe('total likes', () => {
  ...
  test('when list has only one blog equals the likes of that', () => {
    ...
    assert.strictEqual(result, oneBlog[0].likes)
  })
...
describe('favorite blog', () => {
  ...
  test('of one element is the same element', () => {
    const result = listHelper.favoriteBlog(oneBlog)
    assert.deepStrictEqual(result, oneBlog[0])
  })

  test('of multiple elements is the most liked one', () => {
...
describe('most blogs', () => {
  ...
  test('of array with one blog is the same blog', () => {
    const result = listHelper.mostBlogs(oneBlog)
    assert.deepStrictEqual(result, { author: 'Michael Chan', blogs: 1 })
  })

  test('of multiple elements is the author with most blogs', () => {
